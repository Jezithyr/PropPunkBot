...
public record CountryResearchSlotLegacy(CountryModel CountryModel, int SlotNumber, Technology? Tech);
...
public record CountryResearchProgressLegacy(CountryModel CountryModel, Technology Tech, decimal Completion);
